...
class _DoctorAlertsScreenState extends State<DoctorAlertsScreen> {
  ...
  final List<DoctorAlert> _alerts = [
    DoctorAlert(
      ...
      type: AlertType.glucoseCriticalHigh,
      title: 'Critical High Glucose',
      description: 'Glucose reached 298 mg/dL — AID auto-correction delivered 3.5 U. Patient unresponsive to correction after 20 min.',
      timeAgo: '3 min ago',
    ),
    DoctorAlert(
      id: '2',
      ...
      patientInitials: 'CA',
      severity: AlertSeverity.critical,
      type: AlertType.glucoseCriticalLow,
      title: 'Critical Low Glucose',
      description: 'Glucose dropped to 52 mg/dL — AID suspended basal insulin. Patient may need immediate carb intake.',
      timeAgo: '8 min ago',
    ),
    DoctorAlert(
      id: '3',
      ...
      title: 'Incident: Severe Hypoglycemia',
      description: 'Patient experienced severe hypo at 6:02 AM (48 mg/dL). Basal suspended for 45 min. CGM trend was ↓↓ falling fast. AID intervention logged.',
      timeAgo: '2 hours ago',
    ),
    DoctorAlert(
      id: '4',
      ...
      type: AlertType.pumpFailure,
      title: 'Pump Connection Lost',
      description: 'Omnipod 5 lost connection at 10:15 AM. AID system paused. Patient switched to manual mode. Reconnection not confirmed.',
      timeAgo: '25 min ago',
    ),
    DoctorAlert(
      id: '5',
      ...
      title: 'Missed Mealtime Bolus',
      description: 'No bolus recorded around lunch (12:00–13:00). Glucose rose to 188 mg/dL post-meal. Patient did not confirm meal.',
      timeAgo: '1 hour ago',
    ),
    DoctorAlert(
      id: '6',
      ...
      patientInitials: 'MY',
      severity: AlertSeverity.warning,
      type: AlertType.sensorDisconnect,
      title: 'CGM Sensor Disconnected',
      description: 'Dexcom G7 signal lost for 38 minutes. AID running in open loop fallback. Sensor reconnected at 2:44 PM.',
      timeAgo: '3 hours ago',
      isRead: true,
    ),
    DoctorAlert(
      ...
      type: AlertType.timeOutOfRange,
      title: 'High Time Above Range',
      description: 'Patient spent 34% of today above 180 mg/dL. 7-day average TIR is 61%. Care plan review recommended.',
      timeAgo: '5 hours ago',
      isRead: true,
    ),
    DoctorAlert(
      ...
      patientInitials: 'QS',
      severity: AlertSeverity.info,
      type: AlertType.patientInactivity,
      title: 'No CGM Reading for 4 Hours',
      description: 'Last reading recorded at 9:18 AM. Sensor may be expired or detached. Patient has not opened the app today.',
      timeAgo: '6 hours ago',
      isRead: true,
    ),
  ];
  ...
  void _markRead(DoctorAlert alert) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        action: SnackBarAction(
          ...
          onPressed: () => setState(() => alert.isDismissed = false),
        ),
      ),
    );
  }
              ...
              child: visible.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) => _AlertCard(
                        alert: visible[index],
                        onMarkRead: () => _markRead(visible[index]),
                        onDismiss: () => _dismiss(visible[index]),
                        onViewPatient: () {
                          _markRead(visible[index]);
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => PatientDetailsScreen(
                                patientName: visible[index].patientName,
                              ),
                            ),
                          );
                        },
                        onEditPlan: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Opening care plan for ${visible[index].patientName}',
...
class _AlertCard extends StatelessWidget {
  ...
  IconData get _typeIcon {
    switch (alert.type) {
      case AlertType.glucoseCriticalHigh:
        return Icons.arrow_upward_rounded;
      case AlertType.glucoseCriticalLow:
        return Icons.arrow_downward_rounded;
      case AlertType.pumpFailure:
        return Icons.water_drop_outlined;
      case AlertType.sensorDisconnect:
        return Icons.bluetooth_disabled_rounded;
      case AlertType.missedDose:
        return Icons.medication_outlined;
      case AlertType.patientInactivity:
        return Icons.person_off_outlined;
      case AlertType.timeOutOfRange:
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: alert.isRead
            ? null
            : Border.all(color: _severityColor.withValues(alpha: 0.4), width: 1.5),
        boxShadow: [
          BoxShadow(
            color: Colors.black.withValues(alpha: 0.05),
            blurRadius: 10,
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontSize: 14,
                          color: alert.isRead ? Colors.black87 : Colors.black,
                        ),
                      ),
                      const SizedBox(height: 4),
                      // Description
            ...
            child: Wrap(
              ...
              children: [
                ...
                _actionButton(
                  ...
                  bgColor: const Color(0xFF5B8CF5).withValues(alpha: 0.1),
                  onTap: onEditPlan,
                ),
                // View Patient
                _actionButton(
                  ...
                  bgColor: const Color(0xFF2BB6A3).withValues(alpha: 0.1),
                  onTap: onViewPatient,
                ),
              ],
            ),
